            ...
            <div class="page1">
                <div style='width:100%;overflow-y:scroll;'>
                  ...
                  <div v-if="formType === 'carousel'">
                    ...
                    <div v-if="formType === 'carousel'" style="width:100%;height:.15rem;margin-top:20px;text-align:center;">
                  ...
                  <div v-if="formType === 'company'">
                    <div  class="company-dt"   v-if="this.showDtList.length !== 0 && isDisable02">
                      ...
                      <el-form label-width=".5rem" style="overflow-x:hidden;">
                        ...
                        <div class="attribleDiv" style='position:relative;'>
                          ...
                          <template>
                                <div style="width:86%;border:1px solid #ccc;border-radius:3px;height:.8rem;margin-left:.4rem;margin-top:.1rem;overflow-y:scroll;text-align:center;">
                          ...
                          <div style='position:absolute;top:.32rem;left:1px;width:100%;'>
                            <div v-show="tableShow1" style="width:100%;margin-top:.1rem;margin-left:.4rem;">
                                <el-table
                                ref="singleTable"
                                :data="tableData1"
                                max-height="150"
                      ...
                      <div style="padding-bottom:.5rem;">
                        <el-button style="margin-left:20%;width:30%;margin-top:.075rem;float:left;" type="primary" size="small" @click= 'JurisdictionClick(false)'>保存</el-button>
                        <el-button style="margin-left:40px;width:30%;margin-top:.075rem;float:left;" :disabled="isDisabled01" type="primary" size="small" @click= 'exitClcik'>编辑</el-button>
                      </div>
                  </div>
                </div>
            </div>
