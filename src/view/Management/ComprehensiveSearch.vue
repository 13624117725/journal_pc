<template>
    <div class="ComprehensiveSearch">
        <el-form :model="fromData">
            <el-row>
                <el-col :span="9">
                    <el-form-item label="综合搜索" label-width="0.5rem" >
                      <el-input v-model="fromData.keyWord"  @keyup.native.enter="InputSearchClick" placeholder="请输入关键字">
                          <el-button slot="append" icon="el-icon-search" @click="InputSearchClick"></el-button>
                      </el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="产品名称" label-width="0.5rem" >
